...
One way to use it is to have <u>the program generate some random allocation/free</u>
<u>operations</u> and for you to see if you can figure out what the free list would
